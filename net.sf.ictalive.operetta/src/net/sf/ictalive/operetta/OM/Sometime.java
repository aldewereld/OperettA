 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.operetta.OM.Sometime#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.operetta.OM.OMPackage#getSometime()
 * @model
 * @generated
 */
public interface Sometime extends PathFormula {
	 ...
	 * @see net.sf.ictalive.operetta.OM.OMPackage#getSometime_PathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.operetta.OM.Sometime#getPathFormula <em>Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
