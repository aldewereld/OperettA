 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.operetta.OM.impl.VariableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends TermImpl implements Variable {
	...
	protected EClass eStaticClass() {
		return OMPackage.Literals.VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OMPackage.VARIABLE__NAME, oldName, name));
	}
