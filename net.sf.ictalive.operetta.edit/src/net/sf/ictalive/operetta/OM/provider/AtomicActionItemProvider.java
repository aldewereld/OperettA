...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.AtomicAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomicActionItemProvider
	extends ActionDescriptionItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AtomicAction_statement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AtomicAction_statement_feature", "_UI_AtomicAction_type"),
				 OMPackage.Literals.ATOMIC_ACTION__STATEMENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AtomicAction)object).getStatement();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AtomicAction.class)) {
			case OMPackage.ATOMIC_ACTION__STATEMENT:
