...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.Right} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMPackage.Literals.RIGHT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addExprPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Right_Expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Right_Expr_feature", "_UI_Right_type"),
				 OMPackage.Literals.RIGHT__EXPR,
				 true,
				 false,
				 true,
				 null,
