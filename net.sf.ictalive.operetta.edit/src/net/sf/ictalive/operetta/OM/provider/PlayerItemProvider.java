...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.Player} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlayerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_playerID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_playerID_feature", "_UI_Player_type"),
				 OMPackage.Literals.PLAYER__PLAYER_ID,
				 true,
				 false,
				 false,
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_role_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_role_feature", "_UI_Player_type"),
				 OMPackage.Literals.PLAYER__ROLE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Player_type") + " " + player.getPlayerID();
	}
