...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_actions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_actions_feature", "_UI_Sequence_type"),
				 OMPackage.Literals.SEQUENCE__ACTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OMPackage.Literals.SEQUENCE__ACTIONS);
		}
