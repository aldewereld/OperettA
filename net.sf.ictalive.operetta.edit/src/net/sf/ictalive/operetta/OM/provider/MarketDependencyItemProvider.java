...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.MarketDependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MarketDependencyItemProvider
	 ...
	 * @generated
	 */
	public MarketDependencyItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addObjectOfDependencyPropertyDescriptor(Object object) {
		...
		(new ItemPropertyDescriptor
			(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
			 ...
			 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_ObjectOfDependency_feature", "_UI_MarketDependency_type"),
			 ...
			 null)	
			{
				...
				public Collection<?> getChoiceOfValues(Object object) {
					...
					MarketDependency dep = (MarketDependency) object;
					if (dep == null)
						return super.getChoiceOfValues(object);
	...
	/**
	 * This returns MarketDependency.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MarketDependency"));
	}
	...
	public String getText(Object object) {
		String label = ((MarketDependency)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MarketDependency_type") :
			getString("_UI_MarketDependency_type") + " " + label;
	}
