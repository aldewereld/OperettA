...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.Constant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstantItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMPackage.Literals.CONSTANT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addConceptPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constant_concept_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constant_concept_feature", "_UI_Constant_type"),
				 OMPackage.Literals.CONSTANT__CONCEPT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			label; //getString("_UI_Constant_type") + " " + label;
	}
