...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.Conditional} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMPackage.Literals.CONDITIONAL__CONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conditional_action_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conditional_action_feature", "_UI_Conditional_type"),
				 OMPackage.Literals.CONDITIONAL__ACTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OMPackage.Literals.CONDITIONAL__CONDITION);
			childrenFeatures.add(OMPackage.Literals.CONDITIONAL__ACTION);
		}
	...
	public String getText(Object object) {
		String label = ((Conditional)object).write();
		return label;
	}
