...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.NS} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NSItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OMPackage.Literals.NS__NORMS);
			childrenFeatures.add(OMPackage.Literals.NS__TRANSITION_NORMS);
		}
...
//		return getString("_UI_NS_type");
		return "Normative Structure";
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OMPackage.Literals.NS__NORMS,
				 OMFactory.eINSTANCE.createNorm()));

		newChildDescriptors.add
			(createChildParameter
				(OMPackage.Literals.NS__TRANSITION_NORMS,
