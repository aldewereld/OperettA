...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.operetta.OM.Concept} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConceptItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMPackage.Literals.CONCEPT__CONCEPT,
				 true,
				 false,
				 false,
	...
	protected void addURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Concept_URI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Concept_URI_feature", "_UI_Concept_type"),
				 OMPackage.Literals.CONCEPT__URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Concept_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Concept_type_feature", "_UI_Concept_type"),
				 OMPackage.Literals.CONCEPT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Concept)object).getConcept();
