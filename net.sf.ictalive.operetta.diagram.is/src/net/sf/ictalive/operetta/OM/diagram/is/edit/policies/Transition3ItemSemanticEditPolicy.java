 ...
 * @generated
 */
public class Transition3ItemSemanticEditPolicy extends
		OperABaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Transition3ItemSemanticEditPolicy() {
		super(OperAElementTypes.Transition_2106);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (OperAVisualIDRegistry.getVisualID(incomingLink) == SceneToTransitionArcEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (OperAVisualIDRegistry.getVisualID(outgoingLink) == TransitionToSceneArcEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
