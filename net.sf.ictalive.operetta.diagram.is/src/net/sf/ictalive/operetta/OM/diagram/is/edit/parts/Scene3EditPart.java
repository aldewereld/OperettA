...
import net.sf.ictalive.operetta.OM.diagram.is.edit.policies.Scene3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Scene3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Scene3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Scene3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		EndSceneFigure figure = new EndSceneFigure();
	 ...
	 * @generated
	 */
	public EndSceneFigure getPrimaryShape() {
		return (EndSceneFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class EndSceneFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEndSceneFigureLabel;

		/**
		 * @generated
		 */
		public EndSceneFigure() {
		...
		private void createContents() {
			...
			fFigureEndSceneFigureLabel = new WrappingLabel();
			fFigureEndSceneFigureLabel.setText("End");

			fFigureEndSceneFigureLabel.setFont(FFIGUREENDSCENEFIGURELABEL_FONT);

			this.add(fFigureEndSceneFigureLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEndSceneFigureLabel() {
			return fFigureEndSceneFigureLabel;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 135, 5, 5);

	/**
	 * @generated and modified
	 */
	static final Font FFIGUREENDSCENEFIGURELABEL_FONT = new Font(Display
			.getCurrent(),
			Display.getDefault().getSystemFont().getFontData()[0].getName(),
			// Use a smaller font on Linux and Windows, as they seem to use pt size rather than pixel size.
