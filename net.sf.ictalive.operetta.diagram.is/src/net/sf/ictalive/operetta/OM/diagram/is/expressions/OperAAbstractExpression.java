 ...
 * @generated
 */
public abstract class OperAAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = OperAISDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected OperAAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
