 ...
 * @generated
 */
public class SceneSceneIDEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SceneSceneIDEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenEditPolicy() {
			protected org.eclipse.gef.commands.Command getOpenCommand(
					Request request) {
				// the compartment is the second child of this edit part's parent
				SceneSceneCompartmentEditPart sceneEditCompartment = (SceneSceneCompartmentEditPart)SceneSceneIDEditPart.this.getParent().getChildren().get(1);
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OperAParserProvider
					.getParser(
							OperAElementTypes.Scene_2101,
							getParserElement(),
							OperAVisualIDRegistry
									.getType(net.sf.ictalive.operetta.OM.diagram.is.edit.parts.SceneSceneIDEditPart.VISUAL_ID));
		}
		return parser;
	}
