 ...
 * @generated
 */
public class Transition3CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Transition3CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Transition newElement = OMFactory.eINSTANCE.createTransition();

		net.sf.ictalive.operetta.OM.IS owner = (net.sf.ictalive.operetta.OM.IS) getElementToEdit();
		owner.getTransitions().add(newElement);

		OperAElementTypes.init_Transition_2106(newElement);
