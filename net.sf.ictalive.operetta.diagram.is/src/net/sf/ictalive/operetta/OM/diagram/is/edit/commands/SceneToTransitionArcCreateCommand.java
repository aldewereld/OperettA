 ...
 * @generated
 */
public class SceneToTransitionArcCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final net.sf.ictalive.operetta.OM.IS container;

	/**
	 * @generated
	 */
	public SceneToTransitionArcCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Scene) {
			return false;
		}
		...
		return OperABaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSceneToTransitionArc_4102(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		SceneToTransitionArc newElement = OMFactory.eINSTANCE
				.createSceneToTransitionArc();
	 ...
	 * @generated
	 */
	protected void doConfigure(SceneToTransitionArc newElement,
	 ...
	 * @generated
	 */
	public net.sf.ictalive.operetta.OM.IS getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static net.sf.ictalive.operetta.OM.IS deduceContainer(
			EObject source, EObject target) {
		...
		for (EObject element = source; element != null; element = element
			...
			if (element instanceof net.sf.ictalive.operetta.OM.IS) {
				return (net.sf.ictalive.operetta.OM.IS) element;
			}
		}
		return null;
	}
