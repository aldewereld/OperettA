 ...
 * @generated
 */
public class TransitionToSceneArcCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TransitionToSceneArcCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Scene) {
			return false;
		}
		if (getSource() == null) {
		...
		return OperABaseItemSemanticEditPolicy.LinkConstraints
				.canCreateTransitionToSceneArc_4101(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TransitionToSceneArc newElement = OMFactory.eINSTANCE
				.createTransitionToSceneArc();
	 ...
	 * @generated
	 */
	protected void doConfigure(TransitionToSceneArc newElement,
