 ...
 * @generated
 */
public class NetworkDependencyCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NetworkDependencyCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OperABaseItemSemanticEditPolicy.LinkConstraints
				.canCreateNetworkDependency_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		NetworkDependency newElement = OMFactory.eINSTANCE
				.createNetworkDependency();
		getContainer().getDependencies().add(newElement);
		newElement.setDependant1(getSource());
		newElement.setDependant2(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(NetworkDependency newElement,
