...
import net.sf.ictalive.operetta.OM.diagram.ss.part.Messages;
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), SSEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case SSEditPart.VISUAL_ID: {
			...
			OperANavigatorGroup links = new OperANavigatorGroup(
					Messages.NavigatorGroupName_SS_1000_links,
		...
		case NetworkDependencyEditPart.VISUAL_ID: {
			...
			OperANavigatorGroup target = new OperANavigatorGroup(
					Messages.NavigatorGroupName_NetworkDependency_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OperANavigatorGroup source = new OperANavigatorGroup(
					Messages.NavigatorGroupName_NetworkDependency_4001_source,
			...
			connectedViews = getLinksSourceByType(Collections.singleton(view),
					OperAVisualIDRegistry.getType(RoleEditPart.VISUAL_ID));
		...
		case MarketDependencyEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			OperANavigatorGroup target = new OperANavigatorGroup(
					Messages.NavigatorGroupName_MarketDependency_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OperANavigatorGroup source = new OperANavigatorGroup(
					Messages.NavigatorGroupName_MarketDependency_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), OperAVisualIDRegistry
					.getType(RoleEditPart.VISUAL_ID));
		...
		case HierarchyDependencyEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			OperANavigatorGroup target = new OperANavigatorGroup(
					Messages.NavigatorGroupName_HierarchyDependency_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OperANavigatorGroup source = new OperANavigatorGroup(
					Messages.NavigatorGroupName_HierarchyDependency_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), OperAVisualIDRegistry
					.getType(RoleEditPart.VISUAL_ID));
