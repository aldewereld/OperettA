...
public class OperAViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SSEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!SSEditPart.MODEL_ID.equals(OperAVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(SSEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case NetworkDependencyEditPart.VISUAL_ID:
			return createNetworkDependency_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case MarketDependencyEditPart.VISUAL_ID:
			return createMarketDependency_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case HierarchyDependencyEditPart.VISUAL_ID:
			return createHierarchyDependency_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createRole_2001(EObject domainElement, View containerView,
		...
		node.setType(OperAVisualIDRegistry.getType(RoleEditPart.VISUAL_ID));
		...
		Node label5001 = createLabel(node, OperAVisualIDRegistry
				.getType(RoleNameEditPart.VISUAL_ID));
		Node label5002 = createLabel(node, OperAVisualIDRegistry
				.getType(RoleRoleTypeEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createNetworkDependency_4001(EObject domainElement,
		...
		edge.setType(OperAVisualIDRegistry
				.getType(NetworkDependencyEditPart.VISUAL_ID));
		...
		Node label6001 = createLabel(edge, OperAVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createMarketDependency_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(OperAVisualIDRegistry
				.getType(MarketDependencyEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6002 = createLabel(edge, OperAVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createHierarchyDependency_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(OperAVisualIDRegistry
				.getType(HierarchyDependencyEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6003 = createLabel(edge, OperAVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SSEditPart.MODEL_ID.equals(OperAVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put("modelID", SSEditPart.MODEL_ID); //$NON-NLS-1$
