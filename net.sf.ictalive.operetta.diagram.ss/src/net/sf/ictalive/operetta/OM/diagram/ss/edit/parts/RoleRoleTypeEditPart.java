 ...
 * @generated
 */
public class RoleRoleTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RoleRoleTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OperAParserProvider
					.getParser(
							OperAElementTypes.Role_2001,
							getParserElement(),
							OperAVisualIDRegistry
									.getType(net.sf.ictalive.operetta.OM.diagram.ss.edit.parts.RoleRoleTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
