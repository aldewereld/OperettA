	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case RoleRoleTypeEditPart.VISUAL_ID:
				return new RoleRoleTypeEditPart(view);

			case NetworkDependencyEditPart.VISUAL_ID:
				return new NetworkDependencyEditPart(view);

			case NetworkDependencyNameEditPart.VISUAL_ID:
				return new NetworkDependencyNameEditPart(view);

			case MarketDependencyEditPart.VISUAL_ID:
				return new MarketDependencyEditPart(view);

			case MarketDependencyNameEditPart.VISUAL_ID:
				return new MarketDependencyNameEditPart(view);

			case HierarchyDependencyEditPart.VISUAL_ID:
				return new HierarchyDependencyEditPart(view);

			case HierarchyDependencyNameEditPart.VISUAL_ID:
				return new HierarchyDependencyNameEditPart(view);
