...
import net.sf.ictalive.operetta.OM.diagram.ss.part.OperADiagramUpdater;
import net.sf.ictalive.operetta.OM.diagram.ss.part.OperALinkDescriptor;
import net.sf.ictalive.operetta.OM.diagram.ss.part.OperANodeDescriptor;
 ...
 * @generated
 */
public class SSCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = OperADiagramUpdater.getSS_1000SemanticChildren(
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(OMPackage.eINSTANCE.getSS_Roles());
		}
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		if (!SSEditPart.MODEL_ID.equals(OperAVisualIDRegistry.getModelID(view))) {
			return Collections.EMPTY_LIST;
		}
		...
		case NetworkDependencyEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(OperADiagramUpdater
						.getNetworkDependency_4001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case MarketDependencyEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(OperADiagramUpdater
						.getMarketDependency_4002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case HierarchyDependencyEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(OperADiagramUpdater
						.getHierarchyDependency_4003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
