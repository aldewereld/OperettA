 ...
 * @generated
 */
public class MarketDependencyReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MarketDependencyReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MarketDependency) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OperABaseItemSemanticEditPolicy.LinkConstraints
				.canExistMarketDependency_4002(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		net.sf.ictalive.operetta.OM.SS container = (net.sf.ictalive.operetta.OM.SS) getLink()
				.eContainer();
		return OperABaseItemSemanticEditPolicy.LinkConstraints
				.canExistMarketDependency_4002(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected MarketDependency getLink() {
		return (MarketDependency) getElementToEdit();
	}
