 ...
 * @see OMMultipageActionBarContributor
 */
public class SubActionBarsExt extends SubActionBars2 {
	...
	* invoke items[i].release(false); instead of items[i].dispose() leading us to the problem with * some of GMF contributions see SCR: .....
	*/
